import java.util.*;
 public class Chatbot {
    public static void main(String args[]) {
        ...
        String input;
        System.out.println("Chatbot is activated.. type bye to end the chat\n");
        while (true) {
        ...
        if (a.equalsIgnoreCase ("hey") || 
         ...
         a.equalsIgnoreCase("Namaste)") ) {
            ...
            (a.equalsIgnoreCase("i am fine") ||
             a.equalsIgnoreCase("i am fine."))
             System.out.println("Chatbot: ohh! It's good to know that you are fine. im' fine too thank you for asking me..\n would you like me to tell you a joke?");
           else if 
